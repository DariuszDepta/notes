        ...
        nav: [
            {
                ...
                items: [
                    ...
                    {text: 'Fedora 35 solid desktop color', link: '/notes/fedora-35-solid-desktop-color'},
                    ...
                    {text: 'Installing Taskfile', link: '/notes/installing-taskfile'},
                    {text: 'Installing OpenJDK', link: '/notes/installing-open-jdk.md'},
                    {text: 'Nginx Docker registry', link: 'notes/nginx-docker-registry'},
                    ...
                    {text: 'Rust notes', link: '/notes/rust-notes'},
                    ...
                    {text: 'Aliases', link: '/notes/aliases'},
                ]
            }
        ],
        sidebar: [
