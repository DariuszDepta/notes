...
Below is a list of Rust nightly channels for each stable version.

> [!TIP]
> The most recent nightly version is bolded.
...
```shell
rustup target add wasm32-unknown-unknown --toolchain nightly-2024-09-04
```
